...
import { CatTonBooster } from '../wrappers/CatTonBooster';
import '@ton/test-utils';

describe('CatTonBooster', () => {
    let blockchain: Blockchain;
    let deployer: SandboxContract<TreasuryContract>;
    let openedContract: SandboxContract<CatTonBooster>;
    ...
    beforeEach(async () => {
        ...
        const origenContract: CatTonBooster = await CatTonBooster.fromInit(deployer.address);
